...
public class OpenFileDialog {
	...
	public static Dialog createDialog1(int id, Context context, String title, CallbackBundle callback, String suffix, Map<String, Integer> images){
		AlertDialog.Builder builder = new AlertDialog.Builder(context);
		builder.setView(new FileSelectView(context, id, callback, suffix, images));
		Dialog dialog = builder.create();
		//dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
	...
	static class FileSelectView extends ListView implements OnItemClickListener{
		...
		private int refreshFileList()
		{
			...
			//添加适配器
			SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.fileitem, new String[]{"img", "name", "path"}, new int[]{R.id.filedialogitem_img, R.id.filedialogitem_name, R.id.filedialogitem_path});
